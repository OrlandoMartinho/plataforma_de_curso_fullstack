...
//Rota para obter usuarios que pediram assinatura
router.post('/todos_usuarios_assinados',UsersController.obterTodosUsuariosAssinados)
...
router.post('/resetar_senha', UsersController.resetarSenha)
